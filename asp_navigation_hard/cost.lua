...
function dis(a,b)
	...
	if s == 26 then
	    if sp == 27 then ret = 1 end
	end
	if s == 27 then
	    if sp == 26 then ret = 1 end
	end
	if s == 28 then
	    if sp == 29 then ret = 1 end
	end
	if s == 29 then
	    if sp == 28 then ret = 1 end
	end
	if s == 30 then
	    if sp == 31 then ret = 1 end
	end
	if s == 31 then
	    if sp == 30 then ret = 1 end
	end
	if s == 32 then
	    if sp == 33 then ret = 1 end
	end
	if s == 33 then
	    if sp == 32 then ret = 1 end
	end
	return ret
end
